...
public class DeleteLessonMenuUI extends JFrame implements IButtonCode{
	...
	public DeleteLessonMenuUI() {
		...
		JLabel lblNewLabel = new JLabel("\u0418\u0437\u0431\u0435\u0440\u0438 \u043A\u043E\u0439 \u0443\u0440\u043E\u043A \u0434\u0430 \u0438\u0437\u0442\u0440\u0438\u0435\u0448!");
		...
		btnDelContinue.setFont(new Font("Tahoma", Font.PLAIN, 26));
		btnDelContinue.setBounds(20, 539, 346, 69);
		contentPane.add(btnDelContinue);
		...
		btnDelBack.setFont(new Font("Tahoma", Font.PLAIN, 26));
